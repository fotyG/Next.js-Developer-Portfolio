  ...
  return (
    <>
      ...
      <div
        ...
        lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:circularLightLg lg:dark:bg-circularDarkLg
        md:circularLightMd md:dark:bg-circularDarkMd
        sm:circularLightSm sm:dark:bg-circularDarkSm
      "
      >
        <motion.div
          whileHover={{ scale: 1.05 }}
